...
train_pipeline = [
    ...
    dict(type='MyObjectRangeFilter', point_cloud_range=point_cloud_range),
    dict(type='PointShuffle'),
    dict(type='DefaultFormatBundle3D', class_names=class_names),
    dict(type='Collect3D', keys=['points', 'gt_bboxes_3d', 'gt_labels_3d', 'no_aug_gt_bboxes_3d', 'no_aug_gt_labels_3d', 'mask_data', 'mask_anno'])
]
test_pipeline = [
    dict(
        type='LoadPointsFromFile',
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3D', keys=['points', 'mask_data', 'mask_anno'])
        ])
]
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='data/argo2/argo_pickle/argo2_infos_train.pkl',
            split='training',
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='data/argo2/argo_pickle/argo2_infos_val.pkl',
        split='training',
