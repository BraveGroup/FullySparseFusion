...
class MyMultiScaleFlipAug3D(object):
    ...
    def __init__(self,
        ...
        self.pts_rot_ratio = pts_rot_ratio \
            if isinstance(pts_rot_ratio, list) else[float(pts_rot_ratio)]
    ...
    def __call__(self, results):
        ...
        for scale in self.img_scale:
            for pts_scale_ratio in self.pts_scale_ratio:
                for pts_rot_ratio in self.pts_rot_ratio:
